...
class PersonaForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'domicilio':  forms.Textarea(attrs={'class': 'form-comtrol'}),
...
class SolicitudForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            'numero_mascotas': forms.TextInput(attrs={'class': 'form-comtrol'}),
            'razones':  forms.Textarea(attrs={'class': 'form-comtrol'}),
        }
